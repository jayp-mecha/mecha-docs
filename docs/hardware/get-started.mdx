...
You can use any regular Type-C or USB based power supply for the Comet-M that you have lying around. The recommended power supply for the Comet-M is a 5V, 2.5A (12.5W). 

---
sidebar_position: 3
title: Using Public Key Auth
---

# Using Public Key Authentication
It is recommended to use a Public-Private Keypair to authenticate while connecting via SSH. Below tutorial will help you setup the same.
...
- After choosing the key storage directory, you'll be asked to enter a passphrase. This is an extra layer of security, but it's optional. If you don't want to use a passphrase.


:::warning Never share your private key. Keep it in a safe place.
:::
